namespace DfBAdminToolkit.Presenter
{
        ...
        : PresenterBase, ITextSearchPresenter
    {
        ...
        private bool SearchFiles(IMemberServices service/*string url*/, string memberId, ITextSearchModel model, string email)
        {
                ...
                if (response.StatusCode == System.Net.HttpStatusCode.OK)
                {
                    if (response.Data != null)
                    {
                        ...
                        for (int i = 0; i < resultCount; i++)
                        {
                            ...
                            // perform file search
                            if (!SearchFiles(service, memberId, model, email))
                            {
